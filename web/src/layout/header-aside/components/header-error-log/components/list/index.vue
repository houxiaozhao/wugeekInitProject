  ...
  <el-table :data="logReverse" border stripe style="width: 100%" size="mini">
    ...
    <el-table-column prop="type" label="类型" width="80px" align="center" :filters="[
      ...
      <template slot-scope="scope">
        <el-tag v-if="scope.row.type === 'error'" size="mini" type="danger">
    ...
    <el-table-column label="地址" prop="url" width="140px" :show-overflow-tooltip="true">
    </el-table-column>

    <el-table-column label="内容" prop="info" :show-overflow-tooltip="true">
    </el-table-column>
