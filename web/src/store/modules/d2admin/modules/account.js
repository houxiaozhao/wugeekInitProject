...
// import { EventBus } from './../../../../plugin/bus';
let connection = new autobahn.Connection({ url: 'ws://wamp.wugeek.com:90/ws', realm: 'realm1' });
export default {
  namespaced: true,
  actions: {
    /**
    ...
    login(
      ...
      AccountLogin({
        ...
        .then(res => {
          ...
          if (res.errno === 400) vm.$message.error('登陆失败');
          util.cookies.set('uuid', res.data.userinfo._id);
